...
{
    BOOST_CHECK(TestSplitHost("www.etitaniumcore.org", "www.etitaniumcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.etitaniumcore.org]", "www.etitaniumcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.etitaniumcore.org:80", "www.etitaniumcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.etitaniumcore.org]:80", "www.etitaniumcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:34708", "127.0.0.1", 34708));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:34708", "127.0.0.1", 34708));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:34708", "::ffff:127.0.0.1", 34708));
    BOOST_CHECK(TestSplitHost("[::]:34708", "::", 34708));
    BOOST_CHECK(TestSplitHost("::34708", "::34708", -1));
    BOOST_CHECK(TestSplitHost(":34708", "", 34708));
    BOOST_CHECK(TestSplitHost("[]:34708", "", 34708));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:34708", "127.0.0.1:34708"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:34708", "[::]:34708"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
