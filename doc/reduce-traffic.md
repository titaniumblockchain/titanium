...
By default, eTitanium Core allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that etitanium's trustless model works best if you are
