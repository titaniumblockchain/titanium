...
#ifndef ETITANIUM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define ETITANIUM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // ETITANIUM_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
