    ...
    platformStyle(_platformStyle)
{
    ...
    // normal etitanium address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying etitanium address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &eTitaniumAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
