...
"""Verify that starting etitanium with -h works as expected."""

from test_framework.test_framework import eTitaniumTestFramework
from test_framework.util import assert_equal

class HelpTest(eTitaniumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start etitanium with -h for help text")
        ...
        self.log.info("Start etitanium with -version for version information")
        ...
        self.log.info("Start etitaniumd with -fakearg to make sure it does not start")
