...
#ifndef ETITANIUM_COMPAT_ASSUMPTIONS_H
#define ETITANIUM_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "eTitanium cannot be compiled without assertions."
#endif
...
#endif // ETITANIUM_COMPAT_ASSUMPTIONS_H
