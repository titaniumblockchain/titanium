...
//! Entry point for eTitaniumApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &eTitaniumApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for eTitaniumGUI tests.
void AppTests::guiTests(eTitaniumGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &eTitaniumGUI::consoleShown, this, &AppTests::consoleTests);
