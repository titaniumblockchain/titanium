...
class TestShell:
    """Wrapper Class for eTitaniumTestFramework.

    The TestShell class extends the eTitaniumTestFramework
    ...
    class __TestShell(eTitaniumTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by eTitaniumTestFramework child class.
            self.num_nodes = 1
