# Bootstrappable eTitanium Core Builds

This directory contains the files necessary to perform bootstrappable eTitanium
Core builds.
...
- 24GB of free disk space on the partition that the eTitanium Core git repository
  resides in
...
For a eTitanium Core depends development environment, simply invoke
...
From the top of a clean eTitanium Core repository:
...
To use dongcarl's substitute server for eTitanium Core builds after having
