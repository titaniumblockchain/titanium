...
#ifndef ETITANIUM_SCRIPT_SCRIPT_H
#define ETITANIUM_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, eTitanium always counted CHECKMULTISIGs
...
#endif // ETITANIUM_SCRIPT_SCRIPT_H
