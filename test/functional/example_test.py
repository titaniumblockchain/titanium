...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the eTitaniumTestFramework
    pass


class ExampleTest(eTitaniumTestFramework):
    # Each functional test is a subclass of the eTitaniumTestFramework class.
    ...
    def custom_method(self):
        ...
        eTitaniumTestFramework class so other tests can use it."""
