...
#ifndef ETITANIUM_PSBT_H
#define ETITANIUM_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual eTitanium transaction.) Returns true if the merge succeeded, false otherwise. */
