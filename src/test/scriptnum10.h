...
#ifndef ETITANIUM_TEST_SCRIPTNUM10_H
#define ETITANIUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from eTitanium Core 0.10.0, for cross-comparison.
 */
public:
