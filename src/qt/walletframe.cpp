...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, eTitaniumGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &eTitaniumGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &eTitaniumGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &eTitaniumGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &eTitaniumGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &eTitaniumGUI::updateWalletStatus);
    connect(gui, &eTitaniumGUI::setPrivacy, walletView, &WalletView::setPrivacy);
