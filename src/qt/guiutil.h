...
#ifndef ETITANIUM_QT_GUIUTIL_H
#define ETITANIUM_QT_GUIUTIL_H
...
/** Utility functions used by the eTitanium Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "etitanium:" URI into recipient object, return true on successful parsing
