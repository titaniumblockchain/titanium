...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/eTitanium
else
  DOCKER_EXEC echo \> \$HOME/.etitanium
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/etitanium/etitanium/pull/18288#discussion_r433189350 for
  # details.
