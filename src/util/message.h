...
#ifndef ETITANIUM_UTIL_MESSAGE_H
#define ETITANIUM_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's etitanium address, it must refer to a public key.
...
#endif // ETITANIUM_UTIL_MESSAGE_H
