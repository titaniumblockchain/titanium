...
static void SetupeTitaniumTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " etitanium-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  etitanium-tx [options] <hex-tx> [commands]  Update hex-encoded etitanium transaction\n" +
            "or:     etitanium-tx [options] -create [commands]   Create hex-encoded etitanium transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded etitanium transaction
