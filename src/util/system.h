 ...
 */
#ifndef ETITANIUM_UTIL_SYSTEM_H
#define ETITANIUM_UTIL_SYSTEM_H
...
extern const char * const ETITANIUM_CONF_FILENAME;
extern const char * const ETITANIUM_SETTINGS_FILENAME;
