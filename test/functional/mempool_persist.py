...
By default, etitaniumd will dump mempool on shutdown and
...
class MempoolPersistTest(eTitaniumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent etitaniumd from writing mempool.dat to disk. Verify that `savemempool` fails")
