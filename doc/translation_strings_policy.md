...
This document provides guidelines for internationalization of the eTitanium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `etitanium_en.ts` remains unchanged.
