...
#ifndef ETITANIUM_CRYPTO_CHACHA_POLY_AEAD_H
#define ETITANIUM_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@etitanium.
 *
 ...
 *
 * The chacha20-poly1305@etitanium combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@etitanium cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@etitanium are relatively fast in
...
#endif // ETITANIUM_CRYPTO_CHACHA_POLY_AEAD_H
