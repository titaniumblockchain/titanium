...
class P2PPermissionsTests(eTitaniumTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].etitaniumconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].etitaniumconf, 'w', encoding="utf8") as f:
            f.write(newText)
