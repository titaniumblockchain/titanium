    ...
    mapper(nullptr)
{
    ...
    ui->etitaniumAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->etitaniumAtStartup);
    ...
    ui->etitaniumAtStartup->setToolTip(ui->etitaniumAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->etitaniumAtStartup->setText(ui->etitaniumAtStartup->text().arg(PACKAGE_NAME));

    ui->openeTitaniumConfButton->setToolTip(ui->openeTitaniumConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new eTitaniumUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->etitaniumAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openeTitaniumConfButton_clicked()
{
