...
#ifndef ETITANIUM_WALLET_WALLETUTIL_H
#define ETITANIUM_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! etitanium from opening the wallet, thinking it was newly created, and
...
#endif // ETITANIUM_WALLET_WALLETUTIL_H
