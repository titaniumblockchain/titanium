...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the etitanium repository."
  exit 1
fi
...
# See https://github.com/etitanium/etitanium/issues/16064
...
echo 'When compiling etitaniumd, run `./configure` in the following way:'
echo
