...
#ifndef ETITANIUM_WALLET_SCRIPTPUBKEYMAN_H
#define ETITANIUM_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The eTitanium Core wallet was originally a collection of unrelated private
...
#endif // ETITANIUM_WALLET_SCRIPTPUBKEYMAN_H
