...
#ifndef ETITANIUM_WALLET_WALLET_H
#define ETITANIUM_WALLET_WALLET_H
...
public:
     ...
     * on this etitanium node, and set to 0 for transactions that were created
...
#endif // ETITANIUM_WALLET_WALLET_H
