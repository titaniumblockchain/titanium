    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return eTitaniumUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, eTitaniumUnits::SeparatorStyle::NEVER);
            else
                return eTitaniumUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+eTitaniumUnits::shortName(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
